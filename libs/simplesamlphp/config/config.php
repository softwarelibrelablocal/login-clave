...
$config = array(
	...
	'certdir'     => StorkConstants::getCertDirectoryPath(),
	'loggingdir'  => StorkConstants::getLogPath() . '/',
	'datadir'     => 'data/',
	 ...
	 */
	'debug'       => StorkConstants::logEnabled(),
	 ...
	 * 
	 */
	'logging.level'                 => StorkConstants::logLevel(),
